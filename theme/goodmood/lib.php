 ...
 * @return string
 */
function goodmood_user_settings($css, $theme) {
    ...
    $css = goodmood_set_fontsizereference($css, $fontsizereference);
    ...
    $css = goodmood_set_framemargin($css, $framemargin);
    ...
    $css = goodmood_set_headerbgc($css, $headerbgc);
    ...
    $css = goodmood_set_blockcontentbgc($css, $blockcontentbgc);
    ...
    $css = goodmood_set_lblockcolumnbgc($css, $lblockcolumnbgc);
    ...
    $css = goodmood_set_rblockcolumnbgc($css, $rblockcolumnbgc);
    ...
    $css = goodmood_set_blockcolumnwidth($css, $blockcolumnwidth);
    ...
    $css = goodmood_set_blockpadding($css, $blockcolumnwidth, $blockpadding);
    ...
    $css = goodmood_set_customcss($css, $customcss);
 ...
 *
 */
function goodmood_set_fontsizereference($css, $fontsizereference) {
    $tag = '[[setting:fontsizereference]]';
    $css = str_replace($tag, $fontsizereference.'px', $css);
    return $css;
}

function goodmood_set_framemargin($css, $framemargin) {
...
function goodmood_set_headerbgc($css, $headerbgc) {
    $tag = '[[setting:headerbgc]]';
    $css = str_replace($tag, $headerbgc, $css);
    return $css;
}

function goodmood_set_blockcontentbgc($css, $blockcontentbgc) {
    $tag = '[[setting:blockcontentbgc]]';
    $css = str_replace($tag, $blockcontentbgc, $css);
    return $css;
}

function goodmood_set_lblockcolumnbgc($css, $lblockcolumnbgc) {
    $tag = '[[setting:lblockcolumnbgc]]';
    $css = str_replace($tag, $lblockcolumnbgc, $css);
    return $css;
}

function goodmood_set_rblockcolumnbgc($css, $rblockcolumnbgc) {
    $tag = '[[setting:rblockcolumnbgc]]';
    $css = str_replace($tag, $rblockcolumnbgc, $css);
    return $css;
}

function goodmood_set_blockcolumnwidth($css, $blockcolumnwidth) {
...
function goodmood_set_blockpadding($css, $blockcolumnwidth, $blockpadding) {
...
function goodmood_set_customcss($css, $customcss) {
