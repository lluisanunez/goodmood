...
/**
 * Strings for component 'theme_goodmood', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_goodmood
...
<div class="clearfix">
    <div class="theme_screenshot">
        <h2>Goodmood</h2>
        <img src="goodmood/pix/screenshot.gif" />
    ...
    <div class="theme_description">
        <h2>About</h2>
        <p>Goodmood is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
        <h2>Tweaks</h2>
...
$string['configtitle'] = 'Goodmood theme';
...
$string['noframe'] = 'Goodmood 1.9 look';
